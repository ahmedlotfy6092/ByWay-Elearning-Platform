...
export function AddCourseDialog({
  ...
  const [contents, setContents] = useState<
    { name: string; lecturesNumber: string; time: string }[]
  ...
  const handleSave = () => {
    ...
    onAdd({
      ...
      image: image || 'https://images.unsplash.com/photo-1588912914078-2fe5224fd8b8',
      category,
      description,
      certification,
    ...
    setImage('');
    setPreviewUrl('');
    setContents([{ name: '', lecturesNumber: '', time: '' }]);
  };
        ...
        {step === 1 ? (
          <div className="space-y-6 mt-4">
            ...
            <div className="flex justify-between pt-4">
              <Button variant="ghost" onClick={handleCancel} className="text-red-500">
                Cancel
              </Button>
              <Button
                onClick={handleNext}
          ...
          <div className="space-y-6 mt-4">
            ...
            {contents.map((content, index) => (
              <div key={index} className="space-y-4 pb-6 border-b border-border last:border-b-0">
                {/* Name */}
                <div>
